...
Antes de nada, si existe `profesia.config.md` en la raíz del proyecto, leelo: usá el dolor operativo,
la zona de genio y los agentes activos que ya declaró para no repreguntar cosas que ya sabés y para
priorizar mejor la recomendación.
...
reflejado en su dolor operativo dentro de `profesia.config.md`, sugerí agregarlo la próxima vez que
corra `configuracion-inicial` o anotalo vos directamente en esa sección.
